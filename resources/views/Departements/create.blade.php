...
<h1 class="app-page-title">Departements</h1>
                ...
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">Ajouter ici un departement </div>
	                </div>
						    ...
						    <div class="app-card-body">
                                ...
                                @method('post')
								    ...
								    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="setting-input-1" name="name" value="{{old('name')}}" placeholder="Entrer un nom de département" required>
										@error('name')
