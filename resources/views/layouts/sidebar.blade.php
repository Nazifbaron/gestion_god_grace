<div id="app-sidepanel" class="app-sidepanel"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="assets/images/app-logo.svg" alt="logo"><span class="logo-text">{{AppNameGetter::getAppName() ? AppNameGetter::getAppName() : 'GT de Salaire'}}</span></a>
					<img src= style="border-radius:50%"></a>
									...
									<path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
													...
													<div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
														<ul class="submenu-list list-unstyled">
															<li class="submenu-item"><a class="submenu-link" href="{{route('administrateurs')}}">Listes</a></li>
															<li class="submenu-item"><a class="submenu-link" href="{{route('administrateurs.create')}}">Ajouter Administrateur</a></li>
						        						</ul>
					        </div>
					    </li><!--//nav-item-->
					   <!--//nav-item-->
									...
									<path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
													...
													<div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
														<ul class="submenu-list list-unstyled">
															...
															<li class="submenu-item"><a class="submenu-link" href="{{route('employer.create')}}">Ajouter Employer</a></li>
						        						</ul>
					        </div>
					    </li><!--//nav-item-->
